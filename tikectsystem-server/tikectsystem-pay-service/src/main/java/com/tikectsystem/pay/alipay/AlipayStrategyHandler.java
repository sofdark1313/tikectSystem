package com.tikectsystem.pay.alipay;
...
import com.tikectsystem.enums.AlipayTradeStatus;
...
import com.tikectsystem.pay.alipay.config.AlipayProperties;
...
public class AlipayStrategyHandler implements PayStrategyHandler {
    ...
    private Integer convertPayBillStatus(String tradeStatus){
        ...
        throw new TikectsystemFrameException(BaseCode.ALIPAY_TRADE_STATUS_NOT_EXIST);
    }
}
