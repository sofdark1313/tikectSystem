...
import com.tikectsystem.dto.SeatAddDto;
import com.tikectsystem.dto.SeatBatchAddDto;
import com.tikectsystem.dto.SeatBatchRelateInfoAddDto;
import com.tikectsystem.dto.SeatListDto;
...
import com.tikectsystem.enums.SeatType;
...
import com.tikectsystem.service.lua.ProgramSeatCacheData;
...
import com.tikectsystem.vo.SeatRelateInfoVo;
...
import static com.tikectsystem.core.DistributedLockConstants.GET_SEAT_LOCK;
...
public class SeatService extends ServiceImpl<SeatMapper, Seat> {
    ...
    public Long add(SeatAddDto seatAddDto) {
        ...
        if (Objects.nonNull(seat)) {
            throw new TikectsystemFrameException(BaseCode.SEAT_IS_EXIST);
        }
        seat = new Seat();
