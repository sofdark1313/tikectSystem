...
import com.tikectsystem.servicelock.impl.RedissonFairLocker;
import com.tikectsystem.servicelock.impl.RedissonReadLocker;
import com.tikectsystem.servicelock.impl.RedissonReentrantLocker;
import com.tikectsystem.servicelock.impl.RedissonWriteLocker;
import org.redisson.api.RedissonClient;

import java.util.HashMap;
import java.util.Map;

import static com.tikectsystem.servicelock.LockType.Fair;
import static com.tikectsystem.servicelock.LockType.Read;
import static com.tikectsystem.servicelock.LockType.Reentrant;
import static com.tikectsystem.servicelock.LockType.Write;
