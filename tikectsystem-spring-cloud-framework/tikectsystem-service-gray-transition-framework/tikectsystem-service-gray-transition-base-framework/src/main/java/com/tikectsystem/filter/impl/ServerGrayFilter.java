package com.tikectsystem.filter.impl;
...
import static com.tikectsystem.constant.Constant.GRAY_FLAG_FALSE;
import static com.tikectsystem.constant.Constant.GRAY_FLAG_TRUE;
        ...
        try {
            ...
            if (!result && grayFromRequest.equalsIgnoreCase(GRAY_FLAG_TRUE)) {
                if (CollectionUtil.isEmpty(servers)) {
                    throw new TikectsystemFrameException(BaseCode.SERVER_LIST_NOT_EXIST);
                }
