...
public class DefaultExceptionHandler {
    ...
    * 业务异常
    * */
    @ExceptionHandler(value = TikectsystemFrameException.class)
    public ApiResponse<String> toolkitExceptionHandler(HttpServletRequest request, TikectsystemFrameException tikectsystemFrameException) {
        log.error("业务异常 method : {} url : {} query : {} ", request.getMethod(), getRequestUrl(request), getRequestQuery(request), tikectsystemFrameException);
        return ApiResponse.error(tikectsystemFrameException.getCode(), tikectsystemFrameException.getMessage());
    }
    /**
     * 参数验证异常
     */
