...
import com.tikectsystem.MessageConsumer;
import com.tikectsystem.RedisStreamHandler;
import com.tikectsystem.RedisStreamListener;
import com.tikectsystem.RedisStreamPushHandler;
import com.tikectsystem.constant.RedisStreamConstant;
...
public class RedisStreamAutoConfig {
    ...
    public void checkConsumerType(String consumerType){
        if ((!RedisStreamConstant.GROUP.equals(consumerType)) && (!RedisStreamConstant.BROADCAST.equals(consumerType))) {
            throw new TikectsystemFrameException(BaseCode.REDIS_STREAM_CONSUMER_TYPE_NOT_EXIST);
        }
    }
}